...
final_grade_files_template = {
    'IPC033-289 v1': '2024/289/quiz_graded_prop_order{0}.csv',
    'IPC033-290 v1': '2024/290/quiz_graded_prop_order{0}.csv',
    'IPC033-291 v1': '2024/291/quiz_graded_prop_order{0}.csv',
    'IPC033-292 v1': '2024/292/quiz_graded_prop_order{0}.csv',
    'IPC033-293 v1': '2024/293/quiz_graded_prop_order{0}.csv',
    'IPC033-294 v1': '2024/294/quiz_graded_prop_order{0}.csv',
    'IPC033-295 v1': '2024/295/quiz_graded_prop_order{0}.csv',
    'IPC033-309 v1': '2024/309/quiz_graded_prop_order{0}.csv'
}
"""final_grade_files_template = {
    'IPC033-231 v1': '2024_april/231/quiz_graded_prop_order{0}.csv',
    'IPC033-232 v1': '2024_april/232/quiz_graded_prop_order{0}.csv',
    'IPC033-233 v1': '2024_april/233/quiz_graded_prop_order{0}.csv',
    'IPC033-234 v1': '2024_april/234/quiz_graded_prop_order{0}.csv',
    'IPC033-235 v1': '2024_april/235/quiz_graded_prop_order{0}.csv',
    'IPC033-236 v1': '2024_april/236/quiz_graded_prop_order{0}.csv',
    'IPC033-246 v1': '2024_april/246/quiz_graded_prop_order{0}.csv',
    'IPC033-253 v1': '2024_april/253/quiz_graded_prop_order{0}.csv'
}"""
...
for i in valid_numbers:  # Iterates through 0 to 5 for the first number
        ...
        final_grade_files = {key: value.format(i) for key, value in final_grade_files_template.items()}
        ...
        summary_file = f'summary_score_differences__{i}.csv'
...
export_mse_mad_to_csv(os.getcwd(), 'mse_mad_values.csv')
#export_mse_mad_to_csv('2024/309/309/', 'mse_mad_values.csv')
